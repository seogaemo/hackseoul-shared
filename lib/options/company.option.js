...
exports.servicePort = 30003;
exports.grpcClientOptions = (0, nestjs_grpc_reflection_1.addReflectionToGrpcConfig)({
    transport: microservices_1.Transport.GRPC,
    options: {
        url: `${(0, env_1.getServiceHost)("company")}:${exports.servicePort}`,
        package: "company",
        protoPath: (0, path_1.join)(__dirname, "..", "protocols", "company.proto"),
    },
});
//# sourceMappingURL=company.option.js.map